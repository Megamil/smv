							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td valign="top" width="250px" id="negrito">
										<label class="span2">Modelo</label>
									</td>
										
									<td valign="top" width="150px">
										<label class="span2" id="negrito">Prefixo</label>
										<br />
										<label name="dt">DT- </label>
									</td>
										
									<td valign="top" width="150px" id="negrito">
										<label class="span2">KM</label>
									</td>
										
									<td valign="top" width="100px" id="negrito">
										<label class="span2">Data</label>
									</td>
								</tr>
								<tr>
									<td colspan="4" height="50px">
										<label class="span2" id="negrito">Unidade </label>_______________________________________________________________________
									</td>
								</tr>
							</table>
					</fieldset>
												...
												<table border="0" width="100%">
													<tr>
														...
														<td align="right" width="250px" height="30px" valign="bottom">
															<label id="negrito">Nome: </label>__________________________________________________
															<br />&nbsp;
														</td>	
													</tr>
												</table>
