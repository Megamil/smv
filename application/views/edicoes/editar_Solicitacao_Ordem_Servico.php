...
<?php echo form_fieldset("Editar Solicitação de Ordem de Serviço"); 
$form = array('name' => 'form'); 
echo form_open("edicoes/editando_Solicitacao_Ordem_Servico",$form); ?>

	<?php echo form_hidden('id_solicitaordemservico', $pack['solicitaordemservico']->row()->id_solicitaordemservico); ?>
											...
											<option>Selecione...</option>
												<?php 
													...
													foreach ($pack['unidadesaude'] as $unidadesaude) {
														if($pack['solicitaordemservico']->row()->id_unidadesolicitante == $unidadesaude->cnes){
													...
													foreach ($pack['unidadeutilizadora'] as $unidadeutilizadora) {
														...
														if($pack['solicitaordemservico']->row()->id_unidadesolicitante == $unidadeutilizadora->id_unidadeutilizadora){ $selected = 'selected';} else {$selected = '';}
									...
									<div class="controls input-group">
										...
										<?php
											...
											foreach ($pack['veiculo'] as $veiculos) {
												...
												if($pack['solicitaordemservico']->row()->id_veiculo == $veiculos->id_veiculo) {

													echo '<option selected value="'.$veiculos->id_veiculo.'">'.$veiculos->prefixo.'</option>';
											...
											<option>Selecione...</option>
												<?php 
													foreach ($pack['estadoordemservico'] as $estadoordemservico) {
														if($pack['solicitaordemservico']->row()->id_estadosolicitacao == $estadoordemservico->id_estadosolicitacao){
