...
echo form_open("edicoes/editando_Veiculo  ",$name); ?>
	...
	<table border="1">
		...
		<tr>
			...
			<td>
				<div class="control-group">
					<div class="controls">
						<input type="text" class="form-control input_Vazio" disabled name="dtveiculo" value="DT-" aria-describedby="basic-addon1" />
					</div>
					<div class="controls">
						<input type="text" class="form-control input_Vazio" disabled name="prefixoveiculo" value="<?php echo $this->session->flashdata('prefixoveiculo'); ?>" aria-describedby="basic-addon1" />
					</div>
