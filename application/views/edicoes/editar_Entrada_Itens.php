...
echo form_open("editar/editando_Entrada_Itens"); ?>
			...
			<td colspan="2">
				<div class="control-group">
					<div class="controls">
						...
						<select class="form-control input_Vazio" name="fornecedorprestador" placeholder="Fornecedor/Prestador">
							<option>Selecione...</option>
							<?php 
	...
	<?php echo form_submit(array('name'=>'cadastrarNovo'),'Editar Entrada de Itens', 'class="btn btn-success" id="validar_Enviar"'); ?>
