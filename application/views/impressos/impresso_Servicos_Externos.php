				...
				<fieldset class="borda">
					<legend class="borda">Recibo de Entrega do Veículo para Reparos</legend>
							<table width="100%">
								<tr>
									<td colspan="4">
										<span>Nome do prestador dos serviços</span>
										<label name="nomeprestservicos">Nome do prestador dos serviços</label>
									</td>
								</tr>
								...
								<tr>
									<td colspan="4">
										<span>Endereço</span>
										<label name="enderecoprestservicos">Endereço do prestador dos serviços</label>
									</td>
								</tr>
								...
								<tr>
									<td>
										<span>CGC</span>
										<label name="cgc">CGC</label>
									</td>

									<td>
										<span>Data</span>
										<label name="data">____/ ____/ ______</label>
									</td>

									<td colspan="2">
										<span>Assinatura</span>
										<label name="assinatura">___________________________________</label>
									</td>
								</tr>
							</table>
				</fieldset>
