...
<?php echo form_fieldset("Nova Saída de Itens");
$form = array('name' => 'form'); 
echo form_open("criar/nova_Saida_Itens"); ?>
			...
			<td>	
				<div class="control-group">
					<div class="controls">
 						...
 						<input class="form-control input_Vazio" type="text" id="saida" class="form-control input_Vazio" placeholder="Qtd." name="quantidade" aria-describedby="basic-addon1" style="max-width:90px" />
					</div>
				</div>
			</td>
			...
			<td colspan="3">
				<div class="control-group">
					<div class="controls">
 						...
 						<input type="text" class="form-control input_Vazio dataValidar" placeholder="Data Saída" id="datasaida" name="datasaida" aria-describedby="basic-addon1" style="max-width:100px" />
 					</div>
				</div>
			</td>
		</tr>
	...
	<?php echo form_submit(array('name'=>'cadastrarNovo'),'Criar Saída de Itens', 'class="btn btn-success" id="validar_Enviar"'); ?>
