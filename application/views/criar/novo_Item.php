...
echo form_open("criar/novo_Item",$form); ?>
	...
	<table border="0">
		...
		<tr>
			<td colspan="4">
				...
				<div class="control-group">
					<div class="controls">
						<input type="text" class="form-control input_Vazio" onkeypress='return Numero(event)' value="<?php echo $this->session->flashdata('codigomontadora'); ?>" name="codigomontadora" aria-describedby="basic-addon1" placeholder="Código Montadora" style="max-width:160px"/>
					</div>
				</div>
			</td>
		</tr>
		...
		<tr>
			<td valign="top" colspan="3">
				...
				<div class="control-group">
					<div class="controls">
					<input type="text" class="form-control input_Vazio" name="descricao" value="<?php echo $this->session->flashdata('descricao'); ?>" aria-describedby="basic-addon1" placeholder="Descrição do item" maxlength="100" style="max-width:350px"/>
					</div>
				</div>
			</td>
		...
		<tr>
			<td valign="top" colspan="2">
				...
				<div class="control-group">
					<div class="controls">
					<input type="text" class="form-control" name="localizacao" value="<?php echo $this->session->flashdata('localizacao'); ?>" aria-describedby="basic-addon1" placeholder="Localização" />
					</div>
				</div>
			</td>
			...
			<td valign="top">
				...
				<div class="control-group">
					<div class="controls">
					<input type="text" class="form-control" name="gaveta" value="<?php echo $this->session->flashdata('gaveta'); ?>" aria-describedby="basic-addon1" placeholder="Gaveta" style="max-width:120px" maxlength="20"/>
					</div>
				</div>
			</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<p>Para criar um novo grupo você será redirecionado para a tela de criação de grupo. <br> Deseja realmente cancelar a adição do Item?</p>
      </div>
