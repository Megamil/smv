					...
					<?php 
						foreach ($pack['depto'] as $depto) {
							if($this->session->flashdata('depto') == $depto->coddepto){
								echo '<option selected value="'.$depto->coddepto.'"> Código: '.$depto->coddepto.' Departamento: '.$depto->depto.'</option>';
							} else {
								echo '<option value="'.$depto->coddepto.'">Código: '.$depto->coddepto.' Departamento: '.$depto->depto.'</option>';
							}
						}
					?>
				</select>
	...
	<!-- ////////////////////////////////// DIVISÃO ////////////////////////////////// -->
		<tr>
			...
			<td>
				...
				<select class="form-control" name="id_depto" placeholder="Divisão"  style="max-width:100%" >
					<option>Selecione...</option>
					<?php 
						foreach ($pack['divisao'] as $divisao) {
							if($this->session->flashdata('divisao') == $divisao->coddivisao){
								echo '<option selected value="'.$divisao->coddivisao.'"> Código: '.$divisao->coddivisao.' Divisão: '.$divisao->divisao.'</option>';
							} else {
								echo '<option value="'.$divisao->coddivisao.'">Código: '.$divisao->coddivisao.' Divisão: '.$divisao->divisao.'</option>';
							}
						}
					?>
				</select>
	...
	<!-- ////////////////////////////////// SEÇÃO ////////////////////////////////// -->
		<tr>
			...
			<td>
				...
				<select class="form-control" name="id_depto" placeholder="Seção"  style="max-width:100%" >
					<option>Selecione...</option>
					<?php 
						foreach ($pack['secao'] as $secao) {
							if($this->session->flashdata('secao') == $secao->codsecao){
								echo '<option selected value="'.$secao->codsecao.'"> Código: '.$secao->codsecao.' Seção: '.$secao->secao.'</option>';
							} else {
								echo '<option value="'.$secao->codsecao.'">Código: '.$secao->codsecao.' Seção: '.$secao->secao.'</option>';
							}
						}
					?>
				</select>
	...
	<!-- ////////////////////////////////// SETOR ////////////////////////////////// -->
		<tr>
			...
			<td>
				...
				<select class="form-control" name="id_depto" placeholder="Setor"  style="max-width:100%" >
					<option>Selecione...</option>
					<?php 
						foreach ($pack['setor'] as $setor) {
							if($this->session->flashdata('setor') == $setor->codsetor){
								echo '<option selected value="'.$setor->codsetor.'"> Código: '.$setor->codsetor.' Setor: '.$setor->setor.'</option>';
							} else {
								echo '<option value="'.$setor->codsetor.'">Código: '.$setor->codsetor.' Setor: '.$setor->setor.'</option>';
							}
						}
					?>
				</select>
